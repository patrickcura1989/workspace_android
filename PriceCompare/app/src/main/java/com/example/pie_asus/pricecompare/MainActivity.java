...
public class MainActivity extends AppCompatPreferenceActivity
{
    ...
    public static class PerformSearchPreferenceFragment extends PreferenceFragment
    {
        ...
        public void onCreate(Bundle savedInstanceState)
        {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M)
            {
                final WebView pbtechWebview;
                pbtechWebview = new WebView(this.getContext());
            ...
            {
                Toast.makeText(this.getActivity(), "Minimum Android Version is Marshmallow. Program will not work.", Toast.LENGTH_LONG).show();
            }
